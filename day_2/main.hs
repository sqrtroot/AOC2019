...
step m@Machine{currId, program}= case traceShowId . makeOpCode program $ currId of
                                   Add o1 o2 o3 -> Just m{currId=currId + 4, program=update program (singleton (o3, program ! o1 + program ! o2))}
                                   Mul o1 o2 o3 -> Just m{currId=currId + 4, program=update program (singleton (o3, program ! o1 * program ! o2))}
